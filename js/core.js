...
var link_StrayRogue = "<a href=../../project/Bongo Cat/js/\"#\" target=\"_blank\">@StrayRogue</a>";
var link_DitzyFlama = "<a href=../../project/Bongo Cat/js/\"#\" target=\"_blank\">@DitzyFlama</a>";
var link_EricHuber = "<a href=../../project/Bongo Cat/js/\"#\" target=\"_blank\">Eric Huber</a> (<a href=../../project/Bongo Cat/js/\"#\" target=\"_blank\">@Externalizable</a>)";
var i18n_map = {
  "Bongos": {
    "en": "打鼓",
    "ca": "打鼓"},
  ...
  "MEOW": {
    ...
    "ca": "喵～"},
  "other-lang": {
    "en": "<a href=../../project/Bongo Cat/js/\"/?lang=ca\">使用中文(已经被修改)</a>",
    "ca": "<a href=../../project/Bongo Cat/js/\"/?lang=en\">使用中文(已经被修改)</a>"},
  "courtesy": {
  ...
  "website": {
    "en": "网站由 "+link_EricHuber,
    "ca": "网站由"+link_EricHuber},
  "cookies": {
    "en": "本网站使用 cookie 通过匿名和聚合数据来分析流量。",
    "ca": "本网站使用 cookie 通过匿名和聚合数据来分析流量。"}
};
